  ...
  return (
    <section className="py-24 px-6">
      <div className="max-w-3xl mx-auto text-center">
        <div className="relative p-12 rounded-3xl border border-[#00d4ff]/20 bg-gradient-to-b from-[#00d4ff]/5 to-transparent overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <Link
              ...
              className="group inline-flex items-center gap-2 px-8 py-4 rounded-xl font-bold text-white
                         ...
                         hover:shadow-[0_0_40px_rgba(0,212,255,0.5)] transition-all duration-300"
            >
              <Zap size={18} />
